...
#lo  = -73.45; la=-42.95;    # Semi remolino cerca canal chacao
...
# Simulacion
o.run(time_step=3600, outfile ='1prof.nc')
#o.plot(filename='1prof2.jpg')
#o.animation(linecolor='z', fast=True,filename='1prof2.gif')
