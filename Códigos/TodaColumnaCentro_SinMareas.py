...
z = -np.random.rand(200)*250
o.seed_elements(lo, la, z=z, radius=0, number=200,time=time)
...
# Simulacion
o.run(time_step=3600, outfile ='../Resultados/NetCDF/ColumnaCentro_SM.01-31.nc')
o.plot(fast=False,linecolor='z', buffer=.1, show_trajectories=True,filename='../Resultados/Graficos/ColumnaCentro_SM.1-31.jpg')
o.animation(color='z', buffer=.1,fast=False, filename='../Resultados/Animaciones/ColumnaCentro_SM.mp4')
o.animation_profile(color='z', filename='../Resultados/Animaciones/ColumnaCentro_SM.1-31_vert.mp4')
