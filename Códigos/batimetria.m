...
% 
% m_line([-73.4:0.021:-72.66],-42.075,'marker',...
%   's','color',[0 1 0],'linest','none','markerfacecolor','g','clip','point');
% 
% m_line(-73.4,-42.075,'marker','o','color',[0 1 0],...
%     'linest','none','markerfacecolor','r','clip','point');
% 
% m_line(-72.66,-42.075,'marker','o','color',[0 1 0],...
%     'linest','none','markerfacecolor','r','clip','point');
     
% m_line(-72.962497711181641,-42.072647094726562,'marker','o','color',[1 0. 0],...
%           'linest','none','markerfacecolor','r','clip','point'); % SdT diags u
      
% m_line(-72.949996948242190,-42.081922531127930,'marker','p','color',[1 0 0],...
%           'linest','none','markerfacecolor','w','clip','point'); % SdT diags v
% 
m_line(-73.05, [-42.23942:0.015:-41.88683],'marker','s',...
  'color',[1 0. 0],'linest','none','markerfacecolor','r','clip','point');

m_line(-73.05, -42.23942,'marker','o','color',[1 0. 0],...
  'linest','none','markerfacecolor','g','clip','point');
      
m_line(-73.05,-41.88683,'marker','o','color',[1 0. 0],...
  'linest','none','markerfacecolor','g','clip','point');
%       
    title('\fontsize{20} Sección Vertical N-S')
