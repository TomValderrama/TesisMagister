...
# Simulacion
o.run(time_step=3600, outfile ='../Resultados/NetCDF/250m_prof_ColumnasRelDesCha.01-31.nc')
o.plot(fast=False,linecolor='z', buffer=.1, show_trajectories=True,filename='../Resultados/Graficos/250m_prof_ColumnasRelDesCha.1-31.jpg')
o.animation(color='z', buffer=.1,fast=False, filename='../Resultados/Animaciones/250m_prof_ColumnasRelDesCha.mp4')
o.animation_profile(color='z', filename='../Resultados/Animaciones/250m_prof_ColumnasRelDesCha.1-31_vert.mp4')
